 ...
 *
 */
public class Lesson16_Greedy_A_CountIntersectionsSegments {

    public static  int solution(int[] A, int[] B) {
        int N = A.length;
        int[] starts = Arrays.copyOf(A, N);
        int[] ends = Arrays.copyOf(B, N);
        Arrays.sort(starts);
        Arrays.sort(ends);
    ...
    public static void main(String[] args) {
        int[] A = {1, 3, 7, 9, 9};
        int[] B = {5, 6, 8, 9, 10};
        System.out.println(solution(A,B) + " expected 2");
...
/**
 * Contar interecciones de segmenots
